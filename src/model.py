...
# Reads data file provided in the data directory of this repo
data = pd.read_csv("\\path\\to\\data")

# Seperates the data set into input & output
X = data.iloc[:, 0:4]
Y = data.iloc[:, -1]
...
# Constructs xgboost classifier for multi-class classification
